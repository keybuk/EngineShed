...
struct PreviewContent {
    ...
    init() {
        ...
        model.imageData = UIImage(named: "R3736")?.pngData()
        models["R3736"] = model
        ...
        model.era = .theBigFour
        model.imageData = UIImage(named: "R4828")?.pngData()
        models["R4828"] = model
        ...
        model.livery = "LNER Teak"
        model.era = .theBigFour
        model.imageData = UIImage(named: "R4827")?.pngData()
        models["R4827"] = model
        ...
        model.livery = "LNER Teak"
        model.era = .theBigFour
        model.imageData = UIImage(named: "R4826")?.pngData()
        models["R4826"] = model
        ...
        model.era = .theBigFour
        model.imageData = UIImage(named: "R3676")?.pngData()
        models["R3676"] = model
        ...
        model.imageData = UIImage(named: "R3691.1")?.pngData()
        ...
        model.era = .currentEra
        model.imageData = UIImage(named: "R3691.2")?.pngData()
        ...
        model.livery = "GWR Green"
        model.era = .currentEra
        model.imageData = UIImage(named: "R3691.3")?.pngData()
        ...
        model.livery = "GWR Green"
        model.era = .currentEra
        model.imageData = UIImage(named: "R3691.4")?.pngData()
        ...
        model.livery = "GWR Green"
        model.era = .currentEra
        model.imageData = UIImage(named: "R3691.5")?.pngData()
