//
//  DecoderSoundProjectVersionEditTableViewCell.swift
//  EngineShed iOS
//
...
class DecoderSoundProjectVersionEditTableViewCell : UITableViewCell, UITextFieldDelegate {
    ...
    func configureView() {
        textField.text = decoder?.soundProjectVersion
    }
    ...
    func textField(_ textField: UITextField, shouldChangeCharactersIn range: NSRange, replacementString string: String) -> Bool {
        ...
        if !string.isEmpty,
            let suggestion = decoder?.suggestionsForSoundProjectVersion(startingWith: text).first
        {
    ...
    func textFieldDidEndEditing(_ textField: UITextField) {
        ...
        decoder?.soundProjectVersion = textField.text
    }
