//
//  ModelClassEditTableViewCell.swift
//  EngineShed iOS
//
...
class ModelClassEditTableViewCell : UITableViewCell, UITextFieldDelegate {
    ...
    func configureView() {
        textField.text = model?.modelClass
    }
    ...
    func textField(_ textField: UITextField, shouldChangeCharactersIn range: NSRange, replacementString string: String) -> Bool {
        ...
        if !string.isEmpty,
            let suggestion = model?.suggestionsForClass(startingWith: text).first
        {
    ...
    func textFieldDidEndEditing(_ textField: UITextField) {
        ...
        model?.modelClass = textField.text
    }
