//
//  DecoderFirmwareVersionEditTableViewCell.swift
//  EngineShed iOS
//
...
class DecoderFirmwareVersionEditTableViewCell : UITableViewCell, UITextFieldDelegate {
    ...
    func configureView() {
        textField.text = decoder?.firmwareVersion
    }
    ...
    func textField(_ textField: UITextField, shouldChangeCharactersIn range: NSRange, replacementString string: String) -> Bool {
        ...
        if !string.isEmpty,
            let suggestion = decoder?.suggestionsForFirmwareVersion(startingWith: text).first
        {
    ...
    func textFieldDidEndEditing(_ textField: UITextField) {
        ...
        decoder?.firmwareVersion = textField.text

        // Apply the suggested firmware date for this version.
        if let suggestedDate = decoder?.suggestedFirmwareDate() {
            decoder?.firmwareDate = suggestedDate
        }
    }
