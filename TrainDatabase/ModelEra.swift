...
extension ModelEra : CaseIterable {
    ...
    init?(era: Int) {
        ...
        case 3:
            self = .theBigFour
        case 4:
            self = .brSteamEarlyCrest
        case 5:
            self = .brSteamLateCrest
        case 6:
            self = .brCorporateBluePreTOPS
        case 7:
            self = .brCorporateBluePostTOPS
        case 8:
            self = .brSectorisation
        case 9:
            self = .initialPrivatisation
        case 10:
            self = .rebuildingOfTheRailways
        case 11:
            self = .currentEra
        default:
            return nil
