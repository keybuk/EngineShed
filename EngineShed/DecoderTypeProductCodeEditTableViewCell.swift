//
//  DecoderTypeProductCodeEditTableViewCell.swift
//  EngineShed iOS
//
...
class DecoderTypeProductCodeEditTableViewCell : UITableViewCell, UITextFieldDelegate {
    ...
    func configureView() {
        textField.text = decoderType?.productCode
    }
    ...
    func textFieldDidEndEditing(_ textField: UITextField) {
        ...
        decoderType?.productCode = textField.text
    }
