//
//  DecoderTypeManufacturerEditTableViewCell.swift
//  EngineShed
//
...
class DecoderTypeManufacturerEditTableViewCell : UITableViewCell, UITextFieldDelegate {
    ...
    func configureView() {
        textField.text = decoderType?.manufacturer
    }
    ...
    func textField(_ textField: UITextField, shouldChangeCharactersIn range: NSRange, replacementString string: String) -> Bool {
        ...
        if !string.isEmpty,
            let suggestion = decoderType?.suggestionsForManufacturer(startingWith: text).first
        {
    ...
    func textFieldDidEndEditing(_ textField: UITextField) {
        ...
        decoderType?.manufacturer = textField.text
    }
