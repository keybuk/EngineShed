//
//  PurchaseCatalogNumberEditTableViewCell.swift
//  EngineShed iOS
//
...
class PurchaseCatalogNumberEditTableViewCell : UITableViewCell, UITextFieldDelegate {
    ...
    func configureView() {
        textField.text = purchase?.catalogNumber
    }
    ...
    func textFieldDidEndEditing(_ textField: UITextField) {
        ...
        purchase?.catalogNumber = textField.text
    }
