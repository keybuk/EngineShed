//
//  DecoderSoundProjectEditTableViewCell.swift
//  EngineShed iOS
//
...
class DecoderSoundProjectEditTableViewCell : UITableViewCell, UITextFieldDelegate {
    ...
    func configureView() {
        textField.text = decoder?.soundProject
    }
    ...
    func textField(_ textField: UITextField, shouldChangeCharactersIn range: NSRange, replacementString string: String) -> Bool {
        ...
        if !string.isEmpty,
            let suggestion = decoder?.suggestionsForSoundProject(startingWith: text).first
        {
    ...
    func textFieldDidEndEditing(_ textField: UITextField) {
        ...
        decoder?.soundProject = textField.text
    }
