//
//  DecoderSoundAuthorEditTableViewCell.swift
//  EngineShed iOS
//
...
class DecoderSoundAuthorEditTableViewCell : UITableViewCell, UITextFieldDelegate {
    ...
    func configureView() {
        textField.text = decoder?.soundAuthor
    }
    ...
    func textField(_ textField: UITextField, shouldChangeCharactersIn range: NSRange, replacementString string: String) -> Bool {
        ...
        if !string.isEmpty,
            let suggestion = decoder?.suggestionsForSoundAuthor(startingWith: text).first
        {
    ...
    func textFieldDidEndEditing(_ textField: UITextField) {
        ...
        decoder?.soundAuthor = textField.text
    }
