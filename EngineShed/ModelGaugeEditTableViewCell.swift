//
//  ModelGaugeEditTableViewCell.swift
//  EngineShed
//
...
class ModelGaugeEditTableViewCell : UITableViewCell, UITextFieldDelegate {
    ...
    func textField(_ textField: UITextField, shouldChangeCharactersIn range: NSRange, replacementString string: String) -> Bool {
        ...
        if !string.isEmpty,
            let suggestion = model?.suggestionsForGauge(startingWith: text).first
        {
